...
language_selection_dict = { "english_newspapers" : 'en' ,'telugu_newspapers' : 'te','hindi_newspapers':'hi','tamil_newspapers':'ta',"kanada_newspapers":'kn' }
...
def is_government_related(news_text):
    ...
    news_text = language_translation(news_text,'english')
...
def e_print_function(newspaper_lang):
    ...
    for file_name in files_name_folder[0:1]:
        ...
        for id, page in enumerate(doc):
            ...
            pdf_img_path  = "images_from_pdf/" + newspaper_lang + "/samplepdfimage-%i.jpg" % page.number
            ...
            for b, c in zip(boxes, classes):
                if c == 0:
                    ...
                    if newspaper_lang == 'tamil_newspapers':
                        image_to_text = ocr_easy(cropped_image,language_selection_dict[newspaper_lang])
                        
                    if newspaper_lang == 'kanada_newspapers':
                        image_to_text = ocr_easy(cropped_image,language_selection_dict[newspaper_lang])
...
delete_contents_of_directory(r"images_from_pdf")


import threading

# Define the languages
languages = ['english_newspapers','telugu_newspapers', 'hindi_newspapers','tamil_newspapers','kanada_newspapers']
languages = ['telugu_newspapers',]
...
# def main():
#     languages = ["english_newspapers",]
#     languages = ["telugu_newspapers",]
    
#                 #  "telugu_newspapers", "hindi_newspapers"]
