...
channel_name_list = ["TV9TeluguLive","indiatoday","cnnnews18","timesofindia","TheEconomicTimes","TimesNow",]
...
def youtube_video_scrape(channel_name):
    ...
    for title, view, thumb, link, pub_time,duration in zip(titles, views, thumbnails, links, pub_times,durations):
        ...
        video_dict = {
            ...
            'duration of video': duration.text
        }
...
d.to_csv("youtube_data_scrape.csv")