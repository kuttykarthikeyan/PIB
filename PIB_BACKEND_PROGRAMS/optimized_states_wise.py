    ...
    if len(json_resp) != 0:
        ...
        for dis_1 in json_resp:
            ...
            try:
                ...
                particular_url_data['POSITIVE'] = sum([ i['POSITIVE'] for i in split_list_analysis]) / len([ i['POSITIVE'] for i in split_list_analysis])
                ...
                particular_url_data['cluster_sentiment_analysis_result'] = max([ i['SENTIMENT_LABEL'] for i in split_list_analysis])
...
if __name__ == '__main__':
    ...
    if len(final_dataframe_list) != 0:
        ...
        final_data.to_csv("final_data_new.csv",index=False)
    else:
        print("----------------------- Data not came ----------------------------")
